...
public class Key {
  ...
  private static final int[] l = new int[] {
      48, 61, 68, 58, 165, 163, 160, 61, 148, 156, 53, 74, 58, 160, 168, 165, 60, 54, 65, 150, 165, 55, 66, 175, 58, 55, 59, 174, 70, 53, 51, 73, 72,
      170
  };
  private static final int[] I = new int[] {
      68, 55, 54, 50, 49, 63, 62, 49, 63, 60, 67, 60, 61, 49, 60, 56, 52, 64, 62, 51, 74, 58, 160, 168, 165, 60, 54, 61, 68, 58, 165, 163, 160, 50
  };
