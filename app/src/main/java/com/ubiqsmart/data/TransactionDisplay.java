...
public class TransactionDisplay implements Comparable {
  ...
  public TransactionDisplay(String fromAddress, String toAddress, BigInteger amount, int confirmationStatus, long date, String walletName, byte type,
      String txHash, String nounce, long block, int gasUsed, long gasprice, boolean error) {
  ...
  @Override public int compareTo(Object o) {
    if (this.getDate() < ((TransactionDisplay) o).getDate()) return 1;
    if (this.getDate() == ((TransactionDisplay) o).getDate()) return 0;
    return -1;
  }
}
