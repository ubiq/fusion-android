...
public class WalletsFragment extends Fragment implements View.OnClickListener, View.OnCreateContextMenuListener {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    swipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
      @Override public void onRefresh() {
        ...
        try {
          ...
          if (ac != null) ac.snackError("Can't fetch account balances. No connection?");
          e.printStackTrace();
        }
      }
    });
    ...
    leftPress.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View view) {
        ...
        balanceView.setText(
            ExchangeCalculator.getInstance().displayBalanceNicely(ExchangeCalculator.getInstance().convertRate(balance, cur.getRate()))
                + " "
                + cur.getName());
    ...
    FloatingActionButton scan_fab = rootView.findViewById(R.id.scan_fab);
    FloatingActionButton add_fab = rootView.findViewById(R.id.add_fab);
    FloatingActionButton gen_fab = rootView.findViewById(R.id.gen_fab);
        ...
        @Override public void onResponse(Call call, Response response) throws IOException {
          ...
          ac.runOnUiThread(new Runnable() {
            @Override public void run() {
              ...
              balanceView.setText(ExchangeCalculator.getInstance()
                  .displayBalanceNicely(
                      ExchangeCalculator.getInstance().convertRate(balance, ExchangeCalculator.getInstance().getCurrent().getRate()))
                  + " "
  ...
  public void updateBalanceText() {
    if (balanceView != null) {
      balanceView.setText(ExchangeCalculator.getInstance()
          .displayBalanceNicely(ExchangeCalculator.getInstance().convertRate(balance, ExchangeCalculator.getInstance().getCurrent().getRate()))
          + " "
          + ExchangeCalculator.getInstance().getCurrent().getName());
    }
  }
