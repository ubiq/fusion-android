...
import com.ubiqsmart.utils.AppBarStateChangeListener;
...
public class DetailOverviewFragment extends Fragment implements View.OnClickListener, View.OnCreateContextMenuListener, LastIconLoaded {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    swipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
      @Override public void onRefresh() {
        try {
          ...
          if (ac != null) ac.snackError("Connection problem");
          e.printStackTrace();
        }
      }
    });
    ...
    header.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View view) {
        ...
        if (ac != null) ac.broadCastDataSetChanged();
      }
    });

    icon.setImageBitmap(Blockies.INSTANCE.createIcon(ethaddress, 24));
    address.setText(ethaddress);

    FloatingActionButton fab_setName = rootView.findViewById(R.id.set_name);
    ...
    FloatingActionButton send_ether = rootView.findViewById(R.id.send_ether); // Send Ether to
    ...
    FloatingActionButton send_ether_from = rootView.findViewById(R.id.send_ether_from);
    ...
    FloatingActionButton fab_add = rootView.findViewById(R.id.add_as_watch);
    ...
    EtherscanAPI.getInstance().getTokenBalances(ethaddress, new Callback() {
      ...
      @Override public void onResponse(Call call, final Response response) throws IOException {
        try {
          ...
          if (restring != null && restring.length() > 2) RequestCache.getInstance().put(RequestCache.TYPE_TOKEN, ethaddress, restring);
          token.addAll(ResponseParser.parseTokens(ac, restring, DetailOverviewFragment.this));
