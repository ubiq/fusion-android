...
public class FragmentPrice extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    if (ac != null && ac.getPreferences() != null) displayInUsd = ac.getPreferences().getBoolean("price_displayInUsd", true);

    if (ac != null && ac.getPreferences() != null) displayType = ac.getPreferences().getInt("displaytype_chart", 1);
    ...
    if (((App) ac.getApplication()).isGooglePlayBuild()) {
      ((App) ac.getApplication()).track("Price Fragment");
    }
