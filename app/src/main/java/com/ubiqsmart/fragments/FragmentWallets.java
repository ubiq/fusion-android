package com.ubiqsmart.fragments;
...
import com.ubiqsmart.activities.WalletGenActivity;
...
import com.ubiqsmart.activities.QRScanActivity;
...
public class FragmentWallets extends Fragment implements View.OnClickListener, View.OnCreateContextMenuListener {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    if (((App) ac.getApplication()).isGooglePlayBuild()) {
      ((App) ac.getApplication()).track("Wallet Fragment");
    }
